...
void lv_test_object_1(void)
{
    ...
    lv_obj_t * obj1 = lv_obj_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * obj2 = lv_obj_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * obj3_parent = lv_obj_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * obj4_parent = lv_obj_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_set_parent(obj4_2, lv_scr_act(NULL));
    lv_obj_align(obj4_2, obj4_parent, LV_ALIGN_OUT_RIGHT_MID, 10, 0);

    lv_obj_set_parent(obj4_3, lv_scr_act(NULL));
