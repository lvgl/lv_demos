...
{
    lv_color_t bgcolor = LV_COLOR_MAKE(0xec, 0xf0, 0xf1);
    ...
    lv_canvas_fill_polygon(canvas, points5, 4, LV_COLOR_RED, bgcolor);

    lv_canvas_draw_circle(canvas, 25, 54, 10, LV_COLOR_BLACK);
    lv_canvas_flood_fill(canvas, 25, 54, bgcolor, LV_COLOR_RED);
    ...
    lv_canvas_fill_polygon(canvas, points4, 4, LV_COLOR_RED, bgcolor);
    ...
    lv_canvas_fill_polygon(canvas, points3, 4, LV_COLOR_RED, bgcolor);
    ...
    lv_canvas_fill_polygon(canvas, points1, 3, LV_COLOR_RED, bgcolor);
    ...
    lv_canvas_fill_polygon(canvas, points2, 3, LV_COLOR_BLUE, bgcolor);
    ...
    lv_canvas_flood_fill(canvas, 50, 30, LV_COLOR_RED, bgcolor);

    // h. Draw circle
    lv_canvas_draw_circle(canvas, 50, 40, 15, LV_COLOR_BLACK);
    lv_canvas_flood_fill(canvas, 50, 40, LV_COLOR_RED, bgcolor);
