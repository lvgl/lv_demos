...
void lv_test_line_1(void)
{
    ...
    lv_obj_t * line1 = lv_line_create(lv_scr_act(NULL), NULL);
    lv_obj_set_pos(line1, 10, 10);
    lv_line_set_points(line1, p, 3);

    /*Test y invert*/
    lv_obj_t * line2 = lv_line_create(lv_scr_act(NULL), line1);
    ...
    lv_obj_t * line3 = lv_line_create(lv_scr_act(NULL), line2);
    ...
    lv_obj_t * line4 = lv_line_create(lv_scr_act(NULL), line3);
