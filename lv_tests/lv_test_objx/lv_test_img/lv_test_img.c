...
void lv_test_img_1(void)
{
    ...
    lv_obj_t * img1 = lv_img_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * img2 = lv_img_create(lv_scr_act(NULL), img1);
    ...
    lv_obj_t * img3 = lv_img_create(lv_scr_act(NULL), img2);
    lv_obj_set_size(img3, 100, 100);
    lv_obj_align(img3, img2, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);

    /*Test symbol drawing*/
    lv_obj_t * img4 = lv_img_create(lv_scr_act(NULL), NULL);
