...
void lv_test_list_1(void)
{
    ...
    list1 = lv_list_create(lv_scr_act(NULL), NULL);
    lv_obj_set_pos(list1, 10, 10);

    list2 = lv_list_create(lv_scr_act(NULL), NULL);
    ...
    list3 = lv_list_create(lv_scr_act(NULL), list2);
    ...
    list4 = lv_list_create(lv_scr_act(NULL), list3);
    ...
    lv_obj_t * btn_up = lv_btn_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * btn_down = lv_btn_create(lv_scr_act(NULL), btn_up);
