...
void lv_test_bar_1(void)
{
    ...
    lv_obj_t * bar1 = lv_bar_create(lv_scr_act(NULL), NULL);
    lv_obj_set_pos(bar1, 10, 10);
    lv_bar_set_value(bar1, 40);

    /* Modify size and position, range and set to 75 % */
    lv_obj_t * bar2 = lv_bar_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * bar3 = lv_bar_create(lv_scr_act(NULL), bar2);
    ...
    lv_obj_t * bar4 = lv_bar_create(lv_scr_act(NULL), bar2);
    ...
    lv_obj_t * bar5 = lv_bar_create(lv_scr_act(NULL), bar4);
