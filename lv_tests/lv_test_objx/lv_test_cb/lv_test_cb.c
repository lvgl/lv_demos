...
void lv_test_cb_1(void)
{
    ...
    cb3_styles[LV_BTN_STATE_REL].body.gradient_color = COLOR_SILVER;
    ...
    cb3_styles[LV_BTN_STATE_PR].body.gradient_color = COLOR_GRAY;
    ...
    cb3_styles[LV_BTN_STATE_TGL_REL].body.gradient_color = COLOR_BLACK;
    ...
    cb3_styles[LV_BTN_STATE_TGL_PR].body.gradient_color = COLOR_BLACK;
    ...
    cb3_styles[LV_BTN_STATE_INA].body.gradient_color = COLOR_SILVER;
