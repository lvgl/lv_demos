...
void lv_test_lmeter_1(void)
{
    ...
    lv_obj_t * lmeter3 = lv_lmeter_create(lv_scr_act(NULL), lmeter1);
    ...
    lv_obj_t * lmeter4 = lv_lmeter_create(lv_scr_act(NULL), lmeter3);
