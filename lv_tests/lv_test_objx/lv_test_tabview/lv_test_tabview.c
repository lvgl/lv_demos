...
void lv_test_tabview_1(void)
{
    ...
    lv_obj_t * tv1 = lv_tabview_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * tv2 = lv_tabview_create(lv_scr_act(NULL), tv1);
    ...
    /*Apply the styles*/
    lv_obj_t * tv3 = lv_tabview_create(lv_scr_act(NULL), tv2);
    ...
    lv_obj_t * tv4 = lv_tabview_create(lv_scr_act(NULL), tv3);
