...
void lv_test_slider_1(void)
{
    ...
    lv_obj_set_pos_scale(slider1, 10, 10);
    ...
    lv_obj_align_scale(slider2, slider1, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);
    ...
    lv_obj_align_scale(slider3, slider2, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);
    ...
    lv_obj_align_scale(slider5, slider4, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);
