...
void lv_test_slider_1(void)
{
    ...
    lv_obj_t * slider1 = lv_slider_create(lv_scr_act(NULL), NULL);
    lv_obj_set_pos(slider1, 10, 10);

    /* Modify size and position, range and set to 75 % */
    lv_obj_t * slider2 = lv_slider_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * slider3 = lv_slider_create(lv_scr_act(NULL), slider2);
    ...
    lv_obj_t * slider4 = lv_slider_create(lv_scr_act(NULL), slider2);
    ...
    lv_obj_t * slider5 = lv_slider_create(lv_scr_act(NULL), slider4);
