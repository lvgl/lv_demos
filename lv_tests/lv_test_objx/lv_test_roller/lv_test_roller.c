...
{
    /* Default object*/
    lv_obj_t * roller1 = lv_roller_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * roller2 = lv_roller_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * roller3 = lv_roller_create(lv_scr_act(NULL), roller2);
