...
void lv_test_ta_1(void)
{
    ...
    lv_obj_t * ta1 = lv_ta_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * ta2 = lv_ta_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * ta3 = lv_ta_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * ta4 = lv_ta_create(lv_scr_act(NULL), NULL);
...
void lv_test_ta_2(void)
{
    ...
    ta2_1 = lv_ta_create(lv_scr_act(NULL), NULL);
    ...
    btn = lv_btn_create(lv_scr_act(NULL), btn);
