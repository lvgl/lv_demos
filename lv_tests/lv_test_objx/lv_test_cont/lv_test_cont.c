...
void lv_test_cont_1(void)
{
    ...
    lv_obj_t * cont1 = lv_cont_create(lv_scr_act(NULL), NULL);
    lv_obj_set_pos(cont1, 10, 10);
    lv_cont_set_style(cont1, &lv_style_pretty);

    /*Test fit wit adding two labels*/
    lv_obj_t * cont2 = lv_cont_create(lv_scr_act(NULL), cont1);
    ...
    lv_obj_t * cont3 = lv_cont_create(lv_scr_act(NULL), cont2);
    ...
    lv_obj_t * cont4 = lv_cont_create(lv_scr_act(NULL), cont3);
...
void lv_test_cont_2(void)
{
    ...
    lv_obj_t * cont_main = lv_cont_create(lv_scr_act(NULL), NULL);
