...
void lv_tutorial_styles(void)
{
    ...
    lv_obj_t * obj1;
    obj1 = lv_obj_create(lv_scr_act(NULL), NULL);
    ...
    /*Create a simple objects*/
    lv_obj_t * obj2;
    obj2 = lv_obj_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * obj3;
    obj3 = lv_obj_create(lv_scr_act(NULL), NULL);
    ...
    lv_obj_t * bar = lv_bar_create(lv_scr_act(NULL), NULL);
