...
void lv_tutorial_objects(void)
{
     ...
     ***********************/
    /*Create a button*/
    lv_obj_t * btn1 = lv_btn_create(lv_scr_act(NULL), NULL);         /*Create a button on the currently loaded screen*/
    ...
    lv_obj_t * btn2 = lv_btn_create(lv_scr_act(NULL), btn1);        /*Second parameter is an object to copy*/
    ...
    lv_obj_set_size(slider, lv_obj_get_width(lv_scr_act(NULL))  / 3, LV_DPI / 3);   /*Set the size*/
     ...
     ************************/
    lv_obj_t * ddlist = lv_ddlist_create(lv_scr_act(NULL), NULL);            /*Create a drop down list*/
     ...
     * CREATE A CHART
     ****************/
    lv_obj_t * chart = lv_chart_create(lv_scr_act(NULL), NULL);                         /*Create the chart*/
