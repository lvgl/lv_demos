...
//static lv_action_res_t fsel_close_action(lv_obj_t * close, LV_INDEV_t * indev_proc);
//static lv_action_res_t fsel_up_action(lv_obj_t * up, LV_INDEV_t * indev_proc);
//static lv_action_res_t fsel_next_action(lv_obj_t * next, LV_INDEV_t * indev_proc);
//static lv_action_res_t fsel_prev_action(lv_obj_t * prev, LV_INDEV_t * indev_proc);
//static lv_action_res_t fsel_drv_action(lv_obj_t * drv, LV_INDEV_t * indev_proc);
//static lv_action_res_t fsel_drv_lpr_action(lv_obj_t * drv, LV_INDEV_t * indev_proc);
//static lv_action_res_t fsel_folder_action(lv_obj_t * folder, LV_INDEV_t * indev_proc);
//static lv_action_res_t fsel_folder_lpr_action(lv_obj_t * folder, LV_INDEV_t * indev_proc);
//static lv_action_res_t fsel_file_action(lv_obj_t * file, LV_INDEV_t * indev_proc);
//
///**********************
// *  STATIC VARIABLES
// **********************/
