php7.2 img_conv_core.php "name=img_lv_demo_music_icon_1&img=icn_heart.png&cf=true_color_alpha&format=c_array"
php7.2 img_conv_core.php "name=img_lv_demo_music_icon_2&img=icn_chart.png&cf=true_color_alpha&format=c_array"
php7.2 img_conv_core.php "name=img_lv_demo_music_icon_3&img=icn_download.png&cf=true_color_alpha&format=c_array"
php7.2 img_conv_core.php "name=img_lv_demo_music_icon_4&img=icn_chat.png&cf=true_color_alpha&format=c_array"
