...
void lv_ex_obj_1(void)
{
    ...
    lv_style_set_shadow_width(&style_shadow, LV_STYLE_STATE_NORMAL, 10);
    lv_style_set_shadow_spread(&style_shadow, LV_STYLE_STATE_NORMAL, 5);
    lv_style_set_shadow_color(&style_shadow, LV_STYLE_STATE_NORMAL, LV_COLOR_BLUE);
