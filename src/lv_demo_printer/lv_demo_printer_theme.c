...
static void basic_init(void)
{
    ...
    lv_style_set_scrollbar_bg_opa(&style_scrollbar, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_scrollbar_radius(&style_scrollbar, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
    lv_style_set_scrollbar_bg_color(&style_scrollbar, LV_STATE_DEFAULT, LV_DEMO_PRINTER_LIGHT_GRAY);
    lv_style_set_scrollbar_tickness(&style_scrollbar, LV_STATE_DEFAULT, LV_HOR_RES / 80);
    lv_style_set_scrollbar_space_side(&style_scrollbar, LV_STATE_DEFAULT, LV_HOR_RES / 60);
    lv_style_set_scrollbar_space_end(&style_scrollbar, LV_STATE_DEFAULT, LV_HOR_RES / 60);
...
//            break;
        ...
        case LV_DEMO_PRINTER_THEME_LIST:
            list = _lv_obj_get_style_list(obj, LV_OBJ_PART_MAIN);
            _lv_style_list_add_style(list, &style_box);
            _lv_style_list_add_style(list, &style_scrollbar);
            break;

        case LV_DEMO_PRINTER_THEME_LIST_BTN:
            list = _lv_obj_get_style_list(obj, LV_BTN_PART_MAIN);
