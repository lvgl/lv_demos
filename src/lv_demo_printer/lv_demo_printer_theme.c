...
static void basic_init(void)
{
    ...
    lv_style_set_text_color(&style_box, LV_STATE_DEFAULT, LV_DEMO_PRINTER_GRAY);
    ...
    lv_style_set_value_color(&style_sw_bg, LV_STATE_DEFAULT, LV_DEMO_PRINTER_GRAY);
    ...
    lv_style_set_pad_top(&style_slider_knob, LV_STATE_DEFAULT, 12);
    lv_style_set_pad_bottom(&style_slider_knob, LV_STATE_DEFAULT, 12);
    lv_style_set_pad_left(&style_slider_knob, LV_STATE_DEFAULT, 12);
    lv_style_set_pad_right(&style_slider_knob, LV_STATE_DEFAULT,  12);
    lv_style_set_pad_top(&style_slider_knob, LV_STATE_PRESSED, 18);
    lv_style_set_pad_bottom(&style_slider_knob, LV_STATE_PRESSED, 18);
    lv_style_set_pad_left(&style_slider_knob, LV_STATE_PRESSED, 18);
    lv_style_set_pad_right(&style_slider_knob, LV_STATE_PRESSED,  18);
