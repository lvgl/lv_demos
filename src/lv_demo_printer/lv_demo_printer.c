...
//    lv_demo_printer_anim_in(icon, delay + LV_DEMO_PRINTER_ANIM_TIME + LV_DEMO_PRINTER_ANIM_DELAY * 2);
...
//    lv_demo_printer_anim_in(icon, delay + LV_DEMO_PRINTER_ANIM_TIME + LV_DEMO_PRINTER_ANIM_DELAY * 3);
