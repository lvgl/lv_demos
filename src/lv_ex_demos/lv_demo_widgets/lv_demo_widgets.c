...
void lv_demo_widget(void)
{
      ...
      lv_obj_t * t2 = lv_tabview_add_tab(tv, "Visualizers");
      ...
      lv_style_set_pad_inner(&style_box, LV_STATE_NORMAL, LV_DPI / 3);

      controls_create(t1);
//      visualizers_create(t1);
}
...
static void controls_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_style_value_str(h, LV_CONT_PART_MAIN, LV_STATE_NORMAL, "asd");
...
//  lv_bar_set_value(slider, 80, LV_ANIM_ON);
//
//  slider = lv_slider_create(cont, NULL);
////  lv_slider_set_value(slider, 80, LV_ANIM_ON);
//  lv_slider_set_type(slider, LV_SLIDER_TYPE_RANGE);
//  lv_slider_set_value(slider, 50, LV_ANIM_OFF);
//  lv_slider_set_left_value(slider, 10, LV_ANIM_OFF);
//
//#if 1
//
...
//
//
//  lv_obj_t * btnm = lv_btnm_create(cont, NULL);
//  lv_group_add_obj(g1, btnm);
//  lv_coord_t btnm_h = 18 * LV_DPI / 50;
//  lv_obj_set_size(btnm, 7 * btnm_h, btnm_h);
//  lv_btnm_set_map(btnm, btnm_map);
//  lv_btnm_set_btn_ctrl_all(btnm, LV_BTNM_CTRL_CHECKABLE);
//  lv_btnm_set_one_toggle(btnm, true);
//  lv_btnm_set_btn_width(btnm, 0, 2);
//  lv_btnm_set_btn_width(btnm, 4, 2);
//  lv_btnm_set_btn_ctrl(btnm, 0, LV_BTNM_CTRL_INACTIVE);
//
//
...
//
//
//      lv_obj_t * chart = lv_chart_create(t1, NULL);
...
//     lv_chart_set_next(chart, s2, 47);
//
//     lv_obj_t * chart2 = lv_chart_create(t1, chart);
...
//     lv_ta_set_text(ta, "");
//     lv_ta_set_placeholder_text(ta, "E-mail address");
//     lv_ta_set_one_line(ta, true);
//     lv_theme_apply(ta, LV_THEME_TA_ONELINE);
//
//
...
//     lv_list_add_btn(list, LV_SYMBOL_OK, "Okkay");
//     lv_list_add_btn(list, LV_SYMBOL_OK, "Very long okkay to scroll it");
//     lv_list_add_btn(list, LV_SYMBOL_OK, "Okkay");
//
...
////     lv_preload_create(lv_scr_act(), NULL);
//
...
//   lv_obj_set_pos(slider2, 200, 300);
//   lv_obj_set_style_value_str(slider2, LV_SLIDER_PART_KNOB, LV_STYLE_STATE_NORMAL, "xy");
//   lv_obj_set_style_value_str(slider2, LV_SLIDER_PART_KNOB, LV_STYLE_STATE_NORMAL, "xy");
//   lv_obj_set_style_value_align(slider2, LV_SLIDER_PART_KNOB, LV_STYLE_STATE_NORMAL, LV_ALIGN_CENTER);
//   lv_obj_set_style_value_opa(slider2, LV_SLIDER_PART_KNOB, LV_STYLE_STATE_NORMAL, LV_OPA_TRANSP);
//   lv_obj_set_style_value_opa(slider2, LV_SLIDER_PART_KNOB, LV_STYLE_STATE_FOCUS, LV_OPA_COVER);
////   lv_obj_set_style_value_color(slider, LV_SLIDER_PART_KNOB, LV_STYLE_STATE_NORMAL, LV_COLOR_PURPLE);
//   lv_obj_set_style_value_ofs_y(slider2, LV_SLIDER_PART_KNOB, LV_STYLE_STATE_NORMAL, 0);
//   lv_obj_set_style_value_ofs_y(slider2, LV_SLIDER_PART_KNOB, LV_STYLE_STATE_FOCUS, -20);
//   lv_obj_set_style_transition_time(slider2, LV_SLIDER_PART_BG, LV_STYLE_STATE_NORMAL, 400);
//
////
